...
<form action="welcome.php" method="post" name="Login" onsubmit="return validate();">

<h2>Please fill the information below to log in.</h2>
<h3> Email: <input id="1" type="text" name="email" value=""> </h3>
<h3> Password:<input id="2" type="password" name="password" value="" > </h3>
